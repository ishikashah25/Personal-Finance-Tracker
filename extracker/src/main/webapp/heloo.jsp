...
<body>
    ...
    <a href="${IncomeView}">Income Details</a>
		</div>
	<!-- /container -->
	<script
...
input[type="submit"] {
    background-color: #34db4d; /* Updated button color */
    color: #fff;
    padding: 10px;
    border: none;
    border-radius: 4px;
...
a {
    color: #34db4d; /* Updated link color */
    text-decoration: none;
    font-weight: bold;
}
...
<div class="navbar">
    <a href="${address}"> TRACK EXPENSE </a>
    <a href="${empaddress}"> EMPLOYEE EXPENSE TRACKER </a>
</div>
<form:errors path="expense.*" />
	<div class="container">
...
<div class="container">
    <c:if test="${pageContext.request.userPrincipal.name != null}">
        ...
        <h2>
            Welcome ${pageContext.request.userPrincipal.name} | <a style="color:#ffffff" onclick="document.forms['logoutForm'].submit()">Logout</a>
        </h2>
    </c:if>
</div>
